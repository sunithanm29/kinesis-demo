...
public class StockTradesProcessor {
    ...
    private static final Logger PROCESSOR_LOGGER =
            Logger.getLogger("com.kinesis.processor.StockTradeRecordProcessor");

    private KinesisAsyncClient kinesisAsyncClient;
    private static Region region = Region.US_EAST_2;
    private static String streamName = "StockTradeStream";
    private static String applicationName = "StockTradeProcessor";
